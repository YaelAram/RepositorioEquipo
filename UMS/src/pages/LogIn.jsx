  ...
  return (
    <section className="section-create">
      ...
      <form className="form-create" onSubmit={ handleSubmit }>
        ...
        <input type="email" name="email" id="email-user" value={ email } onChange={ onInputChange } className="input-create" />
        <label htmlFor="nom-god">Password: </label>
        <input type="password" name="password" id="pass-user" value={ password } onChange={ onInputChange } className="input-create" />
